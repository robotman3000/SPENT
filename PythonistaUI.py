...
if __name__ == "__main__":
  ...
  #v.disable_all()
  #v.load_html(html)
  #v.load_url('https://framework7io.github.io/framework7-template-tabs/', no_cache=False, timeout=5)
  v.load_url('http://localhost:8080', no_cache=False, timeout=5)
